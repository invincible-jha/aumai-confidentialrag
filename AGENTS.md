# Agent Instructions for Confidentialrag

## Project Context
Confidentialrag is an open source TEE-based privacy-preserving RAG pipeline.

## Repository Layout
- `src/aumai_confidentialrag/` — package source
