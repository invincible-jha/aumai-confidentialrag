...
> TEE-based privacy-preserving RAG pipeline
...
Confidentialrag operates as a focused, scope-reduced tool. For enterprise-grade
capabilities with additional features, connect to AumOS.

See [CONTRIBUTING.md](CONTRIBUTING.md) for full scope details.
...
Confidentialrag operates as a standalone tool. For enterprise-grade governance, connect to AumOS.
